...
- [FIXED] 공용 리더가 즉시 상태를 전환한 뒤 다음 task에서도 같은 의도 상태를 확정하도록 보정했고, 캐시 키를 `20260926-reading-toggle-v3`로 올려 69개 HTML 참조를 전수 동기화했다.
...
- [PENDING] 최종 보정 커밋 push 뒤 Vercel Ready, CI, 운영 JS v3, 로그인된 운영 토글의 열기·닫기·스크롤·URL 불변을 다시 확인한다.
