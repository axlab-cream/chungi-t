...
/*
 * 다음 판단 기준으로 인정하는 행동 서술어.
 *
 * 2026-09-18: 결혼궁합 1차 시도 20회 중 16회가 이 게이트 하나에 떨어졌다. 관계·결혼·돈 상담의
 * 자연스러운 마무리 동사(맞춰 보세요·상의해요·정리해요·나눠 보세요·물어보세요·체크해요·따져 봐요·
 * 메모해요)가 목록에 없어, 시간 표지와 목적어를 갖춘 문장도 통과하지 못했다. 서술어를 넓히되
 * 구조(시간 표지 + 목적어 + 행동)는 그대로 요구한다. 프롬프트의 SECTION_CLOSING_RULES 와 함께 본다.
 */
const nextCriterionAction = /(?:(?:비교|확인)해봐(?:요)?|골라(?:요|보세요)|골라둬(?:요|보세요)?|고르세요|남겨봐(?:요)?|남기세요|적(?:고|어(?:요|봐(?:요)?)?|으세요|으시겠어요|으십시오)|(?:유지|비교|대화|이야기|질문|확인|기록|관찰|점검|선택|합의|보류|조정|복기|정리|상의|의논|논의|검토|체크|메모|계산|구분|분리)(?:해(?:봐(?:요)?|요|세요)?|하십시오|하시겠어요|하는\s*거(?:예요|야))|표시(?:해(?:요)?|하세요|하십시오|하시겠어요)|살펴봐(?:요)?|살펴보세요|살펴보십시오|세워봐(?:요)?|세우세요|세우십시오|정해(?:요)?|정하세요|정하십시오|매겨(?:요)?|매기세요|매기십시오|맞춰(?:요|봐(?:요)?)?|맞추세요|맞추십시오|나눠(?:요|봐(?:요)?)?|나누세요|나누십시오|물어(?:요|봐(?:요)?|보세요|보십시오)|물으세요|따져(?:요|봐(?:요)?)?|따지세요|따지십시오|세어(?:요|봐(?:요)?)?|세(?:어)?보세요|헤아려(?:요|봐(?:요)?)?|지켜봐(?:요)?|지켜보세요|지켜보십시오|챙겨(?:요|봐(?:요)?)?|챙기세요|재(?:봐(?:요)?|보세요|보십시오)|써(?:봐(?:요)?|보세요|보십시오)|그려(?:봐(?:요)?|보세요|보십시오)|짜(?:봐(?:요)?|보세요|보십시오))(?=[,.!?。\s]|$)/
