...
function buildInterpretation(
  ...
  const sections: Partial<Record<ReportFocus, string>> = {
    ...
    action: [
      ...
      `${ragLine} 남부대공 식으로 말하면 이렇습니다. 좋은 운은 기다리는 사람에게 오는 게 아니라, 들어왔을 때 담을 그릇을 만들어둔 사람에게 남습니다. 지금 ${name}님에게 필요한 건 더 많은 예언이 아니라, 이미 보이는 신호를 놓치지 않는 일입니다.`,
    ].join('\n\n'),
  }
  ...
  return [
    {
      ...
      content: [
        ...
        '말투는 “흠...”, “보입니다”, “그 이유가 있습니다”, “좋은 말만 하지는 않겠습니다” 계열의 남부대공 말투를 유지합니다.',
  ...
  return [
    {
      ...
      content: [
        ...
        '말투는 “흠...”, “보입니다”, “그 이유가 있습니다”, “좋은 말만 하지는 않겠습니다” 계열의 남부대공 말투입니다.',
