...
export const WEDDING_TOC = [
  ...
  },
  {
    ...
    items: [
      { id: '2-1', title: '내 기운 기준으로는 어때?', note: '두 명식 각각에 대해 같은 날을 따로 봅니다.', why: '같은 날의 관계가 두 사람에게 다르게 나타날 수 있습니다.' },
      { id: '2-2', title: '남한테 좋아도 나한텐 다른 이유', note: '일반 택일과 개인 명식 기준의 차이를 설명합니다.', why: '왜 결과가 다른지 알면 남의 말에 흔들리지 않습니다.' },
      { id: '2-3', title: '나한테 유리한 결', note: '두 사람에게 공통으로 맞는 결을 찾습니다.', why: '공통 결이 있으면 후보를 좁히기 쉽습니다.' },
    ],
  },
  {
    id: 'better',
    ...
    items: [
      { id: '3-1', title: '이 달 안에서 고르면', note: '입력한 후보 중 같은 달에 있는 날짜를 비교합니다.', why: '예식장 사정상 달을 못 바꾸는 경우가 많습니다.' },
      { id: '3-2', title: '다음 달까지 보면', note: '다음 달의 날짜를 후보로 추가할 때 확인할 기준을 안내합니다.', why: '입력하지 않은 날짜는 계산 결과에 포함하지 않습니다.' },
      { id: '3-3', title: '굳이 안 미뤄도 되는 경우', note: '입력한 일정 제약과 계약 전 확인 조건을 봅니다.', why: '사주 조건만 맞아도 실제로 실행하지 못하면 의미가 없습니다.' },
    ],
  },
  {
    id: 'before',
    ...
    items: [
      ...
      { id: '4-3', title: '사람한테 알릴 순서', note: '알리는 순서와 시점을 잡습니다.', why: '순서가 어긋나면 날짜보다 감정이 문제가 됩니다.' },
    ],
  },
  {
    id: 'onday',
  ...
  },
  {
    ...
    items: [
      { id: '6-1', title: '이후 흐름', note: '예식 뒤 일정과 생활을 정리할 기준을 봅니다.', why: '신혼의 사건이나 관계 변화를 예측하지 않습니다.' },
      { id: '6-2', title: '관계 정리', note: '두 집안 사이의 거리를 어떻게 둘지 봅니다.', why: '관계는 사건보다 거리에서 갈립니다.' },
      { id: '6-3', title: '돈 마무리', note: '비용과 살림을 정리하는 순서를 봅니다.', why: '남은 정산이 신혼 초의 힘을 먼저 씁니다.' },
    ],
  },
] as const
