...
test('all 12 wedding questions have distinct multi-paragraph answers and no cut-off corpus excerpts', () => {
  ...
  assert.equal(new Set(report.sections.map(s=>s.interpretation)).size,12)
