  ...
  const INTERPRETATION_INDEX = [
    {
      id: "company-fit",
      title: "이 회사, 나랑 결 맞아?",
      items: ["전체 핏 판정", "GO/HOLD/협상/보류 시그널"],
    },
    {
      id: "role-fit",
      title: "직무 핏",
      items: ["리더형 업무", "기획·분석형 업무"],
    },
    {
      id: "office-chemistry",
      title: "회사생활 케미",
      items: ["상사 케미", "사내 정치/라인 리스크"],
    },
    {
      id: "money-value",
      title: "돈값 하는 회사인가",
      items: ["연봉 만족도", "지출·기회비용"],
    },
    {
      id: "growth-angle",
      title: "성장각",
      items: ["승진·평가운", "커리어 레벨업 포인트"],
    },
    {
      id: "work-environment",
      title: "업무 환경",
      items: ["출퇴근·근무지 적합도", "원격/비대면 업무 궁합"],
    },
    {
      id: "risk-check",
      title: "리스크 체크",
    ...
    },
    {
      id: "entry-timing",
      title: "입사 타이밍",
      items: ["지금 들어가도 되는 흐름", "대운·유년상 변동기"],
    },
    {
      id: "mental-balance",
      title: "멘탈·워라밸",
      items: ["회사가 내 삶을 잡아먹는지", "오래 버틸 수 있는 루틴"],
    },
    {
      id: "action-plan",
      title: "현실 액션 플랜",
      items: ["오퍼 수락 전 체크리스트", "첫 30·60·90일 전략", "그만둘 각/버틸 각 구분"],
    },
  ];
