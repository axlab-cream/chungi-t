...
function render(group) {
  ...
  return `<!doctype html>
<html lang="ko"><head><script src="/js/umsh-analytics.js?v=ga-20260918a"></script><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escape(title)} · 운명상회</title>
<meta name="description" content="${escape(description)}"><link rel="canonical" href="${base+path}"><meta name="robots" content="index,follow"><meta property="og:type" content="website"><meta property="og:site_name" content="운명상회"><meta property="og:title" content="${escape(title)} · 운명상회"><meta property="og:description" content="${escape(description)}"><meta property="og:url" content="${base+path}"><meta property="og:image" content="${base}/assets/umsh-kakao-share.jpg?v=20260904-wide"><meta name="twitter:card" content="summary_large_image"><link rel="icon" href="/favicon.svg?v=20260917-icon" type="image/svg+xml" /><link rel="icon" href="/favicon.ico?v=20260917-icon" sizes="any" /><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png?v=20260917-icon" /><link rel="icon" type="image/png" sizes="192x192" href="/icon-192.png?v=20260917-icon" /><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?v=20260917-icon" /><link rel="manifest" href="/manifest.json?v=20260917-icon" /><link rel="stylesheet" href="/css/policy.css?v=20260909-logo"><link rel="stylesheet" href="/css/faq-knowledge.css?v=20260909-126">${group?'':'<link rel="stylesheet" href="/css/faq-media-webp.css?v=20260921">'}<script type="application/ld+json">${JSON.stringify(schema).replace(/</g,'\\u003c')}</script><script src="/js/faq-knowledge.js?v=20260909-126" defer></script><link rel="stylesheet" href="/css/umsh-chrome.css"><script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/dist/umd/supabase.min.js"></script><script src="/js/common-auth-return.js"></script><script src="/js/umsh-auth-session.js"></script><script src="/js/umsh-chrome.js?v=20260922c"></script></head>
...
<section class="knowledge-intro"><h1>${escape(group?group.name:title)}</h1><p>${escape(group?group.intro:'어떤 상담이 맞을지, 이용 중 막힌 문제는 어떻게 확인할지 찾아보세요.')}</p><div class="knowledge-meta"><span>${group?`${items.length}개 질문 · 전체 ${all.length}개 안내`:`${all.length}개 질문 · ${groups.length}개 분류`}</span><span>내용 확인 ${data.updated.replaceAll('-','.')}</span></div></section>${group?'':'\n<figure class="knowledge-hero-art"><img src="/assets/faq-study-v2.webp" alt="나경과 고서, 봉투가 놓인 운명상회 상담 서재" width="1536" height="1024"><figcaption>이용 방법부터 결과의 근거까지, 필요한 답을 분류별로 확인하세요.</figcaption></figure>'}
