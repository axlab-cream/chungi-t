...
const CONTRACTS = [
  ...
  ['src/match/couple-service.ts', 'COUPLE_MATCH_TOC', '대분류 목차'],
  ['src/match/couple-service.ts', '../love/reading-content.js', '대분류별 해석 문장 테이블'],
  ['src/match/couple-service.ts', "const OWN_CORPUS_DOMAIN = 'match_couple_service'", '코퍼스 도메인 게이트'],
  ['src/match/couple-service.ts', 'retrieveCategoryOwnChunks', 'RAG 근거 추출'],
