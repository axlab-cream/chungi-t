...
const CONTRACTS = [
  ...
  ['src/money/save-service.ts', 'MONEY_SAVE_TOC', '대분류 목차'],
  ['src/money/save-service.ts', './practical-readings.js', '대분류별 해석 문장 테이블'],
  ['src/money/save-service.ts', "const OWN_CORPUS_DOMAIN = 'money_save_service'", '코퍼스 도메인 게이트'],
