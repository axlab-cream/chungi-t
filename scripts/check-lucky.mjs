...
const CONTRACTS = [
  ...
  // 이 두 가지는 fdc80f2 에서 공용 모듈로 옮겨졌다. 심볼 이름이 아니라 하는 일을 본다.
  ['src/body/lucky-service.ts', "const OWN_CORPUS_DOMAIN = 'lucky_color_service'", '코퍼스 도메인 게이트'],
  ['src/body/lucky-service.ts', 'retrieveCategoryOwnChunks', '자기 코퍼스 우선 검색'],
  ['src/body/lucky-service.ts', 'practicalReading', 'RAG 근거 추출'],
  ['src/report/practical-service-copy.ts', 'export function elementEvidence', '오행 근거 생성'],
